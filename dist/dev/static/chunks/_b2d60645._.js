...
"[project]/hooks/useIRISWebSocket.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useIRISWebSocket(url = "ws://localhost:8000/ws/iris", autoConnect = true) {
    ...
    const [confirmedNodes, setConfirmedNodes] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const [currentSubnode, setCurrentSubnode] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    // WebSocket ref
    ...
    const cleanup = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useIRISWebSocket.useCallback[cleanup]": ()=>{
    ...
    const connect = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useIRISWebSocket.useCallback[connect]": ()=>{
            ...
            try {
                ...
                ws.onmessage = ({
                    "useIRISWebSocket.useCallback[connect]": (event)=>{
                        try {
                ...
                ws.onerror = ({
                    "useIRISWebSocket.useCallback[connect]": (error)=>{
                ...
                ws.onclose = ({
                    "useIRISWebSocket.useCallback[connect]": (event)=>{
                        ...
                        if (autoConnect && reconnectAttemptsRef.current < 3) {
                            ...
                            }["useIRISWebSocket.useCallback[connect]"], delay);
                        }
                    }
                })["useIRISWebSocket.useCallback[connect]"];
                wsRef.current = ws;
    ...
    const handleMessage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useIRISWebSocket.useCallback[handleMessage]": (message)=>{
                ...
                case "field_updated":
                    {
                        ...
                        if (subnode_id && field_id !== undefined) {
                            setFieldValues({
                                "useIRISWebSocket.useCallback[handleMessage]": (prev)=>({
                                        ...prev,
                                        [subnode_id]: {
                                            ...prev[subnode_id],
                                            [field_id]: value
                            ...
                            }["useIRISWebSocket.useCallback[handleMessage]"]);
                        }
                        break;
                    }
    ...
    const sendMessage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useIRISWebSocket.useCallback[sendMessage]": (type, payload = {})=>{
            if (wsRef.current?.readyState === WebSocket.OPEN) {
    ...
    }["useIRISWebSocket.useCallback[sendMessage]"], []);
    // Action methods
    const selectCategory = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useIRISWebSocket.useCallback[selectCategory]": (category)=>{
            sendMessage("select_category", {
                category
            });
        }
    }["useIRISWebSocket.useCallback[selectCategory]"], [
        sendMessage
    ]);
    const selectSubnode = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useIRISWebSocket.useCallback[selectSubnode]": (subnodeId)=>{
            if (subnodeId) {
    ...
    }["useIRISWebSocket.useCallback[selectSubnode]"], [
        sendMessage
    ]);
    const updateField = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useIRISWebSocket.useCallback[updateField]": (subnodeId, fieldId, value)=>{
            // Optimistic local update
            setFieldValues({
                "useIRISWebSocket.useCallback[updateField]": (prev)=>({
                        ...prev,
                        [subnodeId]: {
                            ...prev[subnodeId],
                            [fieldId]: value
            ...
            }["useIRISWebSocket.useCallback[updateField]"]);
            // Send to server
    ...
    const confirmMiniNode = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useIRISWebSocket.useCallback[confirmMiniNode]": (subnodeId, values)=>{
            sendMessage("confirm_mini_node", {
                subnode_id: subnodeId,
                values
            });
        }
    }["useIRISWebSocket.useCallback[confirmMiniNode]"], [
        sendMessage
    ]);
    const updateTheme = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useIRISWebSocket.useCallback[updateTheme]": (glowColor, fontColor, stateColors)=>{
            // Optimistic local update
            setTheme({
                "useIRISWebSocket.useCallback[updateTheme]": (prev)=>({
                        ...prev,
                        ...glowColor && {
                            glow: glowColor,
                            primary: glowColor
            ...
            }["useIRISWebSocket.useCallback[updateTheme]"]);
            // Send to server
    ...
    const requestState = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useIRISWebSocket.useCallback[requestState]": ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useIRISWebSocket.useEffect": ()=>{
            ...
            const interval = setInterval({
                "useIRISWebSocket.useEffect.interval": ()=>{
                    sendMessage("ping", {});
                }
            }["useIRISWebSocket.useEffect.interval"], 30000) // Ping every 30 seconds
            ;
            return ({
                "useIRISWebSocket.useEffect": ()=>clearInterval(interval)
            })["useIRISWebSocket.useEffect"];
        }
    }["useIRISWebSocket.useEffect"], [
        isConnected,
...
_s(useIRISWebSocket, "Q8MVb3Tap2Zu6z4Dasm2GwopEjk=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/components/fields/FieldWrapper.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/components/fields/TextField.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$fields$2f$FieldWrapper$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/fields/FieldWrapper.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$BrandColorContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/contexts/BrandColorContext.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function TextField({ label, value, placeholder, onChange, description, error }) {
    _s();
    const { getHSLString } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$BrandColorContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useBrandColor"])();
    const glowColor = getHSLString();
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$fields$2f$FieldWrapper$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FieldWrapper"], {
        label: label,
...
_s(TextField, "0aAHZF6njxts5D2sY9UBEZqLg8Y=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$BrandColorContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useBrandColor"]
    ];
});
_c = TextField;
var _c;
...
"[project]/components/fields/SliderField.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SliderField({ label, value, min, max, step = 1, unit = "", onChange, description, showValue = "beside" }) {
    ...
    const handleInteraction = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SliderField.useCallback[handleInteraction]": (clientX, isFineControl)=>{
    ...
    }["SliderField.useCallback[handleInteraction]"], [
        min,
        max,
        step,
        onChange
    ...
    const handleMouseMove = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SliderField.useCallback[handleMouseMove]": (e)=>{
            if (isDragging) {
                handleInteraction(e.clientX, e.shiftKey);
            }
        }
    }["SliderField.useCallback[handleMouseMove]"], [
        isDragging,
        handleInteraction
    ]);
    const handleMouseUp = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SliderField.useCallback[handleMouseUp]": ()=>{
            setIsDragging(false);
        }
    }["SliderField.useCallback[handleMouseUp]"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
            ...
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        showTooltip && showValue === "tooltip" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                showValue === "beside" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
_s(SliderField, "zQQylCaHBAM3aErYJZur35xA0Zc=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$BrandColorContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useBrandColor"]
    ];
});
...
"[project]/components/fields/DropdownField.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function DropdownField({ label, value, options, loadOptions, onChange, placeholder = "Select...", description, searchable = false }) {
    ...
    const [loadedOptions, setLoadedOptions] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DropdownField.useEffect": ()=>{
            if (isOpen && loadOptions && !loadedOptions && !isLoading) {
                setIsLoading(true);
                loadOptions().then({
                    "DropdownField.useEffect": (opts)=>{
                        setLoadedOptions(opts);
                        setIsLoading(false);
                    }
                }["DropdownField.useEffect"]).catch({
                    "DropdownField.useEffect": ()=>setIsLoading(false)
                }["DropdownField.useEffect"]);
            }
        }
    }["DropdownField.useEffect"], [
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DropdownField.useEffect": ()=>{
            const handleClickOutside = {
                "DropdownField.useEffect.handleClickOutside": (e)=>{
                    if (containerRef.current && !containerRef.current.contains(e.target)) {
                        setIsOpen(false);
                    }
                }
            }["DropdownField.useEffect.handleClickOutside"];
            document.addEventListener("mousedown", handleClickOutside);
            return ({
                "DropdownField.useEffect": ()=>document.removeEventListener("mousedown", handleClickOutside)
            })["DropdownField.useEffect"];
        }
    }["DropdownField.useEffect"], []);
                ...
                isOpen && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        isLoading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            className: "py-1",
                            children: filteredOptions.map((option)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    type: "button",
                                    onClick: (e)=>{
                                        e.stopPropagation();
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            option.downloaded !== undefined && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
_s(DropdownField, "8kn1+ac66ZjPPBStIzjaAce9ffM=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$BrandColorContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useBrandColor"]
    ];
});
_c = DropdownField;
var _c;
__turbopack_context__.k.register(_c, "DropdownField");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/components/fields/ToggleField.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
_s(ToggleField, "0aAHZF6njxts5D2sY9UBEZqLg8Y=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$BrandColorContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useBrandColor"]
    ];
});
...
"[project]/components/fields/ColorField.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/components/mini-node-card.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$fields$2f$TextField$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/fields/TextField.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$fields$2f$SliderField$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/fields/SliderField.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$fields$2f$DropdownField$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/fields/DropdownField.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$fields$2f$ToggleField$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/fields/ToggleField.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$fields$2f$ColorField$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/fields/ColorField.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$BrandColorContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/contexts/BrandColorContext.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
...
function getIcon(iconName) {
    ...
    return icons[iconName] || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$lucide$2d$react$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.Circle;
}
        ...
        case 'text':
            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$fields$2f$TextField$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TextField"], {
                        label: "",
        ...
        case 'slider':
            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$fields$2f$SliderField$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SliderField"], {
                        label: "",
        ...
        case 'dropdown':
            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$fields$2f$DropdownField$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DropdownField"], {
                        label: "",
        ...
        case 'toggle':
            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$fields$2f$ToggleField$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ToggleField"], {
                        label: "",
        ...
        case 'color':
            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$fields$2f$ColorField$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ColorField"], {
                        label: "",
...
function MiniNodeCard({ miniNode, isActive, values, onChange, onSave, index }) {
    ...
    const { getThemeConfig } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$BrandColorContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useBrandColor"])();
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].createElement(IconComponent, {
                                className: "w-5 h-5",
                                style: {
                                    color: '#ffffff',
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: miniNode.fields?.map((field)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "text-xs",
...
_s(MiniNodeCard, "rz/Vk7w+ekv2+F5Hk7zzuNcDgfs=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$BrandColorContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useBrandColor"]
    ];
});
_c = MiniNodeCard;
var _c;
__turbopack_context__.k.register(_c, "MiniNodeCard");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/components/mini-node-stack.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$components$2f$AnimatePresence$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/framer-motion/dist/es/components/AnimatePresence/index.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$lucide$2d$react$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/lucide-react/dist/esm/lucide-react.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$mini$2d$node$2d$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/mini-node-card.tsx [app-client] (ecmascript)");
...
function MiniNodeStack({ miniNodes }) {
    ...
    const { state, updateMiniNodeValue, confirmMiniNode, jumpToMiniNode, rotateStackForward, rotateStackBackward } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$NavigationContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useNavigation"])();
    ...
    const handleValueChange = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MiniNodeStack.useCallback[handleValueChange]": (nodeId, fieldId, value)=>{
            updateMiniNodeValue(nodeId, fieldId, value);
        }
    }["MiniNodeStack.useCallback[handleValueChange]"], [
        updateMiniNodeValue
    ]);
    const handleSave = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MiniNodeStack.useCallback[handleSave]": (nodeId)=>{
            const values = miniNodeValues[nodeId] || {};
            confirmMiniNode(nodeId, values);
        }
    }["MiniNodeStack.useCallback[handleSave]"], [
        confirmMiniNode,
        miniNodeValues
    ]);
    const handleCardClick = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MiniNodeStack.useCallback[handleCardClick]": (index)=>{
            jumpToMiniNode(index);
        }
    }["MiniNodeStack.useCallback[handleCardClick]"], [
        jumpToMiniNode
    ]);
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$components$2f$AnimatePresence$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AnimatePresence"], {
                    ...
                    children: visibleNodes.map((miniNode, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$mini$2d$node$2d$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MiniNodeCard"], {
                                miniNode: miniNode,
...
_s(MiniNodeStack, "j4Fw6g9CHenDuCZ5ujw50yJjGog=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$BrandColorContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useBrandColor"],
...
_c = MiniNodeStack;
var _c;
__turbopack_context__.k.register(_c, "MiniNodeStack");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/hooks/useTransitionVariants.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$TransitionContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/contexts/TransitionContext.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$transitions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/transitions.ts [app-client] (ecmascript)");
var _s = __turbopack_context__.k.signature();
'use client';
;
;
function useTransitionVariants() {
    _s();
    const { currentTransition } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$TransitionContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTransition"])();
    const variants = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$transitions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getVariantsForTransition"])(currentTransition);
    const staggerDelay = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$transitions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getStaggerDelay"])(currentTransition);
...
_s(useTransitionVariants, "ZOUpchxqbRJtlBCNypsq3vTl+HY=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$TransitionContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTransition"]
    ];
});
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
...
"[project]/components/iris/prism-node.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/framer-motion/dist/es/render/components/motion/proxy.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$BrandColorContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/contexts/BrandColorContext.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useTransitionVariants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/hooks/useTransitionVariants.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function PrismNode({ node, angle, radius, nodeSize, onClick, spinRotations, spinDuration, staggerIndex, isCollapsing, isActive, spinConfig, themeIntensity = 'medium' }) {
    ...
    const { getThemeConfig } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$BrandColorContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useBrandColor"])();
    const { variants } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useTransitionVariants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTransitionVariants"])();
...
_s(PrismNode, "BZmic1BANr4bItSBTXYDkpYKrpI=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$BrandColorContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useBrandColor"],
        __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useTransitionVariants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTransitionVariants"]
    ];
});
_c = PrismNode;
const HexagonalNode = PrismNode;
var _c;
__turbopack_context__.k.register(_c, "PrismNode");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/components/hexagonal-control-center.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useIRISWebSocket$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/hooks/useIRISWebSocket.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$NavigationContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/contexts/NavigationContext.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$BrandColorContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/contexts/BrandColorContext.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$mini$2d$node$2d$stack$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/mini-node-stack.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$iris$2f$prism$2d$node$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/iris/prism-node.tsx [app-client] (ecmascript)");
;
...
if (("TURBOPACK compile-time value", "object") !== 'undefined' && window.__TAURI__) {
    try {
        const tauriWindow = __turbopack_context__.r("[project]/node_modules/@tauri-apps/api/window.cjs [app-client] (ecmascript)");
...
const SUB_NODES = {
    voice: [
        ...
        },
        {
            id: "processing",
            label: "PROCESSING",
            icon: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$audio$2d$waveform$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__AudioWaveform$3e$__["AudioWaveform"],
            fields: [
                {
                    id: "noise_reduction",
...
function useIsMobile() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useIsMobile.useEffect": ()=>{
            const checkMobile = {
                "useIsMobile.useEffect.checkMobile": ()=>setIsMobile(window.innerWidth < 640)
...
const ICON_MAP = {
    ...
    Waveform: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$audio$2d$waveform$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__AudioWaveform$3e$__["AudioWaveform"],
    ...
    FileStack: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$file$2d$stack$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__FileStack$3e$__["FileStack"],
...
function useManualDragWindow(onClickAction) {
    ...
    const windowStartPos = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])({
        x: 0,
        y: 0
    });
    const hasDragged = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false);
    const handleMouseDown = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useManualDragWindow.useCallback[handleMouseDown]": async (e)=>{
    ...
    }["useManualDragWindow.useCallback[handleMouseDown]"], []);
    const handleMouseMove = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useManualDragWindow.useCallback[handleMouseMove]": (e)=>{
    ...
    }["useManualDragWindow.useCallback[handleMouseMove]"], []);
    const handleMouseUp = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useManualDragWindow.useCallback[handleMouseUp]": ()=>{
...
_s1(useManualDragWindow, "Kzi5NXQMhZ2x8XDv1+GaVgTjgDM=");
function IrisOrb({ isExpanded, onClick, centerLabel, size, glowColor }) {
    _s2();
    const { handleMouseDown } = useManualDragWindow(onClick);
    const [isWaking, setIsWaking] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
...
_s2(IrisOrb, "VIwyF08j0JNnmMR99AKgx/Hz3y0=", false, function() {
    return [
        useManualDragWindow
    ];
});
...
function HexagonalControlCenter() {
    _s3();
    const nav = (0, __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$NavigationContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useNavigation"])();
    const { getThemeConfig, theme: brandTheme, setTheme } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$BrandColorContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useBrandColor"])();
    const theme = getThemeConfig();
    const themeGlowColor = theme.glow.color;
    // DEBUG: Log theme state
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "HexagonalControlCenter.useEffect": ()=>{
    ...
    const { theme: wsTheme, confirmedNodes: wsConfirmedNodes, currentCategory, currentSubnode, selectCategory, selectSubnode, confirmMiniNode, updateTheme } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useIRISWebSocket$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useIRISWebSocket"])("ws://localhost:8000/ws/iris");
    ...
    const [exitingView, setExitingView] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const [activeMiniNodeIndex, setActiveMiniNodeIndex] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const isMobile = useIsMobile();
    // Refs for tracking navigation state and preventing stale closures
    const userNavigatedRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false);
    const navLevelRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(nav.state.level);
    const nodeClickTimestampRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "HexagonalControlCenter.useEffect": ()=>{
            if (!getCurrentWindow) return;
            const setupWindow = {
                "HexagonalControlCenter.useEffect.setupWindow": async ()=>{
                    const appWindow = await getCurrentWindow();
                    await appWindow.setIgnoreCursorEvents(false);
                }
            }["HexagonalControlCenter.useEffect.setupWindow"];
            setupWindow();
        }
    }["HexagonalControlCenter.useEffect"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
    ...
    const handleNodeClick = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "HexagonalControlCenter.useCallback[handleNodeClick]": (nodeId, nodeLabel, hasSubnodes)=>{
            ...
            if (shouldNavigate) {
                ...
                if (SUB_NODES[nodeId]?.length > 0) {
                    ...
                    setTimeout({
                        "HexagonalControlCenter.useCallback[handleNodeClick]": ()=>{
                    ...
                    }["HexagonalControlCenter.useCallback[handleNodeClick]"], SPIN_CONFIG.spinDuration);
                } else {
    ...
    const handleSubnodeClick = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "HexagonalControlCenter.useCallback[handleSubnodeClick]": (subnodeId)=>{
            ...
            if (activeSubnodeId === subnodeId) {
                ...
                const subnodeData = SUB_NODES[currentView]?.find({
                    "HexagonalControlCenter.useCallback[handleSubnodeClick]": (n)=>n.id === subnodeId
                }["HexagonalControlCenter.useCallback[handleSubnodeClick]"]);
                // Transform fields into proper MiniNode objects - each field becomes a card in the stack
                const fields = subnodeData?.fields || [];
                const miniNodes = fields.map({
                    "HexagonalControlCenter.useCallback[handleSubnodeClick].miniNodes": (field, index)=>({
                ...
                }["HexagonalControlCenter.useCallback[handleSubnodeClick].miniNodes"]);
    ...
    const handleIrisClick = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "HexagonalControlCenter.useCallback[handleIrisClick]": (e)=>{
            ...
            if (level === 4) {
                ...
                setTimeout({
                    "HexagonalControlCenter.useCallback[handleIrisClick]": ()=>{
                        userNavigatedRef.current = false;
                        console.log('[Nav System] userNavigatedRef reset after Level 4->3 navigation');
                    }
                }["HexagonalControlCenter.useCallback[handleIrisClick]"], 100);
            } else if (level === 3) {
                ...
                }["HexagonalControlCenter.useCallback[handleIrisClick]"], SPIN_CONFIG.spinDuration);
            } else if (level === 2) {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$components$2f$AnimatePresence$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AnimatePresence"], {
                    children: confirmedNodes.map((node)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].createElement(ICON_MAP[typeof node.icon === 'string' ? node.icon : 'Mic'] || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$mic$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Mic$3e$__["Mic"], {
                                        className: "w-5 h-5",
                                        style: {
                                            color: glowColor
                                        },
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(IrisOrb, {
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$components$2f$AnimatePresence$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AnimatePresence"], {
                    children: nav.state.level === 4 && nav.state.miniNodeStack.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$mini$2d$node$2d$stack$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MiniNodeStack"], {
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$components$2f$AnimatePresence$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AnimatePresence"], {
                    children: (nav.state.level === 2 || nav.state.level === 3) && exitingNodes && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                        children: exitingNodes.map((node, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$iris$2f$prism$2d$node$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PrismNode"], {
                                node: node,
                                angle: node.angle,
...
_s3(HexagonalControlCenter, "uCXAJ9A6L8S0SGHpKClpvisSTIQ=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$NavigationContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useNavigation"],
        __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$BrandColorContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useBrandColor"],
        __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useIRISWebSocket$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useIRISWebSocket"],
        useIsMobile
    ];
});
_c1 = HexagonalControlCenter;
var _c, _c1;
__turbopack_context__.k.register(_c, "IrisOrb");
__turbopack_context__.k.register(_c1, "HexagonalControlCenter");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_b2d60645._.js.map