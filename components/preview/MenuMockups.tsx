...
const MOCKUPS = [
  ...
  { key: 'radial-arc-web', title: 'C — Random Rotate', badge: '★ WINNER', description: 'Winner. Each click randomly picks one of: Spiral Dissolve, Gravity Drop, or Magnet Pull. Enter: nodes reverse the transition with Photon Burst flash (brightness 1→3→1, scale 1→1.25→1).', Component: MockupTransitionSpiral },
