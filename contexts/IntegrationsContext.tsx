...
export function IntegrationsProvider({ 
  ...
  const wsUrl = customWsUrl || process.env.NEXT_PUBLIC_WS_URL || (typeof window !== 'undefined' ? `ws://${window.location.hostname}:8090/ws/iris_integration` : 'ws://127.0.0.1:8090/ws/iris_integration');
