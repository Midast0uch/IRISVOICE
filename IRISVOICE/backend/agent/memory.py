...
class ConversationMemory:
    ...
    def _prune_if_needed(self) -> None:
        ...
        while total_tokens > self.max_context_tokens and len(self.messages) > 2:
            ...
            logger.info(f"[ConversationMemory] Pruned old message, freed {removed.text_tokens + removed.audio_tokens} tokens")
    ...
    def clear(self) -> None:
        ...
        self.messages.clear()
        self.session_start = time.time()
        logger.info("[ConversationMemory] Conversation cleared")
