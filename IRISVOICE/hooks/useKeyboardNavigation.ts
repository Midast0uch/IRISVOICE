 ...
 * - 8.2: Escape at UI_STATE_BOTH_OPEN returns to UI_STATE_IDLE
 * - 8.3: Escape closes all open wings simultaneously
 * - 8.4: Wings close via Escape use same animations as clicking the Orb
 * - 8.5: Voice command functionality is preserved
 * 
